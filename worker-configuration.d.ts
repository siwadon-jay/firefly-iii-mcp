/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3ff1cc07c233434648dd865f865e2717)
// Runtime types generated with workerd@1.20250525.0 2025-05-27 nodejs_compat_v2
declare namespace Cloudflare {
	interface Env {
		FIREFLY_III_BASE_URL: string;
		FIREFLY_III_PAT: string;
		FIREFLY_III_PRESET: string;
		FIREFLY_III_TOOLS: string;
